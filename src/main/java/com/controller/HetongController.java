...
public class HetongController {
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request) {
        ...
        PageUtils page = hetongService.queryPage(params, request);
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request) {
        ...
        HetongView view = hetongService.getViewById(id, request);
        if (view != null) {
    ...
    public R save(@RequestBody HetongEntity hetong, HttpServletRequest request) {
        ...
        hetongService.saveWithDefaults(hetong, request);
        return R.ok();
    }
    ...
    public R update(@RequestBody HetongEntity hetong, HttpServletRequest request) {
        ...
        hetongService.updateSanitized(hetong);
        return R.ok();
    }
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request) {
        ...
        hetongService.softDeleteBatch(ids);
        return R.ok();
    }
}
