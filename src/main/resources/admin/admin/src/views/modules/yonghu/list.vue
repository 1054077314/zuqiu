    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="用户编号">
          <el-input v-model="searchForm.yonghuUuidNumber" placeholder="请输入用户编号" clearable />
        </el-form-item>
      ...
      <el-form :inline="true" class="toolbar-content">
        <el-form-item>
          <el-button type="success" icon="el-icon-plus" @click="addOrUpdateHandler()">新增用户</el-button>
          <el-button
            type="danger"
            icon="el-icon-delete"
      ...
      <div class="table-content">
        ...
        >
          ...
          <el-table-column prop="yonghuUuidNumber" label="用户编号" min-width="130" />
          <el-table-column prop="yonghuName" label="用户姓名" min-width="120" />
...
export default {
  ...
  methods: {
    ...
    resetPassword(id) {
      this.$confirm('确定将该用户密码重置为 123456 吗？', '提示', {
