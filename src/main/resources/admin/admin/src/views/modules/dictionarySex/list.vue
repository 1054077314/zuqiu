  ...
  <div class="main-content">
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="性别类型名称">
          <el-input v-model="searchForm.indexName" placeholder="请输入性别类型名称" clearable />
        </el-form-item>
        <el-form-item>
      ...
      <el-form :inline="true" class="toolbar-content">
        <el-form-item>
          <el-button type="success" icon="el-icon-plus" @click="addOrUpdateHandler()">新增性别类型</el-button>
          <el-button
            type="danger"
            icon="el-icon-delete"
