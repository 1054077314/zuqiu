    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="公告类型名称">
          <el-input v-model="searchForm.indexName" placeholder="请输入公告类型名称" clearable />
        </el-form-item>
        <el-form-item>
      ...
      <el-form :inline="true" class="toolbar-content">
        <el-form-item>
          <el-button type="success" icon="el-icon-plus" @click="addOrUpdateHandler()">新增公告类型</el-button>
          <el-button
            type="danger"
            icon="el-icon-delete"
      ...
      <div class="table-content">
        ...
        >
          ...
          <el-table-column prop="indexName" label="公告类型名称" min-width="220" show-overflow-tooltip />
